package int101.homework02Updated;
...
public class Int101Homework02Updated {
    ...
    static void work01Utilitor() {
       ...
       1.5 Show in this "work01Utilitor" method how to
        ...
        System.out.println(Utilitor.computeIsbn10(30640615));
        System.out.println(Utilitor.computeIsbn10(468324615));
    }
    ...
    static void work02Person() {
       ...
       2.11 Show in this "work02Person" method how to
        ...
        System.out.println("\n--------work02Person--------");
        Person person1 = new Person("Kittikorn", "Voraprateep");
        Person person2 = new Person("Kittikorn", "VP");
        //test Constructor, toString
//        System.out.println(new Person("", "unknown"));
        System.out.println(person1);
        System.out.println(person2);
        System.out.println(new Person("Meepooh", "404"));
        //test getter
        System.out.println("person2 firstname =" + person2.getFirstname());
        System.out.println("person2 lastname =" + person2.getLastname());
        //test setter
        System.out.println(person1);
        person1.setFirstname("Meepooh");
        person1.setLastname("404");
        System.out.println("Set person1 ---> " + person1);
        //test equals()
        System.out.println(person1);
        System.out.println(person2);
        System.out.println("person1 is same person2 ---> " + person1.equals(person2));
        System.out.println("person1 is same new person ---> " + person1.equals(new Person("Meepooh", "404")));
    }
    ...
    static void work03Account() {
       ...
       3.13 Show in this "work03Account" method how to
        ...
        System.out.println("\n--------work03Account--------");
        Person person1 = new Person("Kitti", "V1");
        Person person2 = new Person("Kitti", "V2");
        ...
        //getter, deposit, withdraw, transfer
        System.out.println(account1.getNo());
        account1.deposit(49999);
        //account1.deposit(-23324); //Cannot deposit
        System.out.println("account1 deposit -> balance: " + account1.getBalance());
        account1.withdraw(5000);
        System.out.println("account1 withdraw -> balance: " + account1.getBalance());
        account2.withdraw(235);//balance not pass
        System.out.println(account2);
        //account1.withdraw(-24356);//amount not pass

        //transfer
        System.out.println("Transfer");
        account1.transfer(7000, account3);
        System.out.println("balance account1 ---> " + account1.getBalance());
        System.out.println("balance account3 ---> " + account3.getBalance());
//        account1.transfer(-122, account3); //not pass
//        account2.transfer(1223, account1); //not pass
    }
}
